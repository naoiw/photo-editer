...
export function ImageFilePicker({
  ...
  return (
    <div className="grid gap-2">
      ...
      <button
        className={`grid gap-4 rounded-lg border border-dashed px-5 py-6 text-left transition-colors ${dragging ? 'border-accent bg-accent/5' : 'border-line bg-panel hover:bg-soft'}`}
